...
**Fixture inventory:** The listed groups total **496** fixtures (249 tokens, 118 folding, 54 SQLi, 68 HTML5, and 7 XSS). The migration pins this inventory and requires zero failures.
...
This is the Go compatibility reference. The accepted Rust migration records two
intentional hardening deviations—malformed numeric exponents and oversized
numeric HTML entities—in [ADR 0001](adr/0001-libinjection-rust-migration.md).
Any further deviation requires an explicit decision and differential coverage.
