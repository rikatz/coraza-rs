...
| coraza-rs `libinjection-rs/` | **In-workspace replacement** | Stage-1 implementation is present; Coraza still uses crates.io `libinjectionrs` until the migration gates pass. |
